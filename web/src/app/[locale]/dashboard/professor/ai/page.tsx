...
const ProfessorAIPage = () => {
  ...
  const aiFeatures: AIFeature[] = [
    ...
    {
      id: 'course-generator',
      name: t('courseGenerator') || 'Course Generator',
      description: t('courseGeneratorDesc') || 'Generate complete, curriculum-aligned courses with syllabus, materials, and assessments in minutes.',
      icon: WandSparklesIcon,
      color: 'from-emerald-500 to-teal-600',
      path: `/${locale}/dashboard/professor/ai/course-generator`,
      image: 'https://images.pexels.com/photos/5905709/pexels-photo-5905709.jpeg',
    },
    {
      id: 'assignment-generator',
      name: t('assignmentGenerator') || 'Assignment Generator',
      description: t('assignmentGeneratorDesc') || 'Create engaging assignments, quizzes, and exams with automatic answer keys and grading rubrics.',
      icon: FileText,
